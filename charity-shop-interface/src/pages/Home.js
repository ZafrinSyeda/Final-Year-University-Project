			 ...
			 description of what the feature should entail, and provides links to the respective pages */}
				...
				<div className="threeContainer">
					<div className="containerItem">
						<a href="/shop" className="pageLink" aria-label="">
							{" "}
						...
						<p className="description">
							...
							proceeds will go to our partner charities. Take a look - we add
					...
					<div className="containerItem">
						...
						<p className="description">
							Have any old clothes or furniture lying around? We can come over
							to pick up any large items and send them to one of our partner
					...
					<div className="containerItem">
						...
						<p className="description">
							You can donate money to a charity of your choice from our website
							if there is a cause that you are passionate about
						</p>
					</div>
				</div>
			</div>
